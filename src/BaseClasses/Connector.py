...
class Connector(Connectable.Connectable):
  ...
  def connect(self,connection):
    ...
    if len(self.connections) == 2:
      raise CircuitExceptions.ConnectionError("Resistor "+self+"cannot connect to more than two places.")
    ...
    if isinstance(connection, Connector):
      junc=Junction.Junction(self,connection, name="AutoGeneratedJunction")
      return
