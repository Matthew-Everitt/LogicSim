...
class BaseClass(object):
  ...
  __usedNames={} #Shared accross all initialisations, this records the number of times a certain name has been requested, so we can append something to it to ensure that it's unique.
